 #  [10/15] RUN pip list
 #  0.706 Package                           Version
 #  0.706 --------------------------------- ----------
 #  0.707 anyio                             3.7.0
 #  0.707 argon2-cffi                       21.3.0
 #  0.707 argon2-cffi-bindings              21.2.0
 #  0.708 arrow                             1.2.3
 #  0.708 asttokens                         2.2.1
 #  0.708 async-lru                         2.0.2
 #  0.708 attrs                             22.2.0
 #  0.709 Babel                             2.12.1
 #  0.709 backcall                          0.2.0
 #  0.709 beautifulsoup4                    4.12.2
 #  0.710 bleach                            6.0.0
 #  0.710 certifi                           2023.5.7
 #  0.710 cffi                              1.15.1
 #  0.711 charset-normalizer                3.1.0
 #  0.711 colorama                          0.4.6
 #  0.711 comm                              0.1.3
 #  0.711 contourpy                         1.0.7
 #  0.712 coverage                          7.2.2
 #  0.712 cycler                            0.11.0
 #  0.712 debugpy                           1.6.7
 #  0.713 decorator                         5.1.1
 #  0.713 defusedxml                        0.7.1
 #  0.713 exceptiongroup                    1.1.1
 #  0.714 executing                         1.2.0
 #  0.714 fastjsonschema                    2.17.1
 #  0.714 fonttools                         4.39.3
 #  0.715 fqdn                              1.5.1
 #  0.715 future                            0.18.3
 #  0.715 greenlet                          2.0.2
 #  0.715 h5py                              3.8.0
 #  0.716 idna                              3.4
 #  0.716 importlib-metadata                6.7.0
 #  0.716 importlib-resources               5.12.0
 #  0.717 iniconfig                         2.0.0
 #  0.717 ipykernel                         6.23.3
 #  0.717 ipython                           8.11.0
 #  0.718 ipython-genutils                  0.2.0
 #  0.718 ipython-sql                       0.5.0
 #  0.718 ipywidgets                        8.0.6
 #  0.719 isoduration                       20.11.0
 #  0.719 jedi                              0.18.2
 #  0.719 Jinja2                            3.1.2
 #  0.719 json5                             0.9.14
 #  0.720 jsonpointer                       2.4
 #  0.720 jsonschema                        4.17.3
 #  0.720 jupyter                           1.0.0
 #  0.721 jupyter_client                    8.3.0
 #  0.721 jupyter-console                   6.6.3
 #  0.721 jupyter-contrib-core              0.4.2
 #  0.722 jupyter-contrib-nbextensions      0.7.0
 #  0.722 jupyter_core                      5.3.1
 #  0.722 jupyter-events                    0.6.3
 #  0.723 jupyter-highlight-selected-word   0.2.0
 #  0.723 jupyter-lsp                       2.2.0
 #  0.723 jupyter-nbextensions-configurator 0.6.3
 #  0.723 jupyter_server                    2.7.0
 #  0.724 jupyter_server_terminals          0.4.4
 #  0.724 jupyterlab                        4.0.2
 #  0.724 jupyterlab-pygments               0.2.2
 #  0.725 jupyterlab_server                 2.23.0
 #  0.725 jupyterlab-widgets                3.0.7
 #  0.725 kiwisolver                        1.4.4
 #  0.726 kotlin-jupyter-kernel             0.11.0.385
 #  0.726 lxml                              4.9.2
 #  0.726 MarkupSafe                        2.1.3
 #  0.727 matplotlib                        3.7.1
 #  0.727 matplotlib-inline                 0.1.6
 #  0.727 mistune                           3.0.1
 #  0.727 mpi4py                            3.1.4
 #  0.728 nbclassic                         1.0.0
 #  0.728 nbclient                          0.8.0
 #  0.728 nbconvert                         7.6.0
 #  0.729 nbformat                          5.9.0
 #  0.729 nest-asyncio                      1.5.6
 #  0.729 notebook                          6.5.4
 #  0.730 notebook_shim                     0.2.3
 #  0.730 numpy                             1.24.2
 #  0.730 olefile                           0.46
 #  0.731 openmc                            0.13.3
 #  0.731 overrides                         7.3.1
 #  0.731 packaging                         23.0
 #  0.731 pandas                            1.5.3
 #  0.732 pandocfilters                     1.5.0
 #  0.732 parso                             0.8.3
 #  0.732 pexpect                           4.8.0
 #  0.733 pickleshare                       0.7.5
 #  0.733 Pillow                            9.4.0
 #  0.733 pip                               23.1.2
 #  0.734 platformdirs                      3.8.0
 #  0.734 plotly                            5.15.0
 #  0.734 pluggy                            1.0.0
 #  0.735 prettytable                       3.8.0
 #  0.735 prometheus-client                 0.17.0
 #  0.735 prompt-toolkit                    3.0.38
 #  0.735 psutil                            5.9.5
 #  0.736 psycopg2-binary                   2.9.6
 #  0.736 ptyprocess                        0.7.0
 #  0.736 pure-eval                         0.2.2
 #  0.737 pycparser                         2.21
 #  0.737 Pygments                          2.14.0
 #  0.737 pyparsing                         3.0.9
 #  0.737 pyrsistent                        0.19.3
 #  0.738 pytest                            7.2.2
 #  0.738 pytest-cov                        4.0.0
 #  0.738 python-dateutil                   2.8.2
 #  0.739 python-dotenv                     1.0.0
 #  0.739 python-json-logger                2.0.7
 #  0.739 pytz                              2023.3
 #  0.739 PyYAML                            6.0
 #  0.740 pyzmq                             25.1.0
 #  0.740 qtconsole                         5.4.3
 #  0.740 QtPy                              2.3.1
 #  0.741 requests                          2.31.0
 #  0.741 rfc3339-validator                 0.1.4
 #  0.741 rfc3986-validator                 0.1.1
 #  0.741 scipy                             1.10.1
 #  0.742 Send2Trash                        1.8.2
 #  0.742 setuptools                        52.0.0
 #  0.742 six                               1.16.0
 #  0.743 sniffio                           1.3.0
 #  0.743 soupsieve                         2.4.1
 #  0.743 SQLAlchemy                        2.0.17
 #  0.743 sqlparse                          0.4.4
 #  0.744 stack-data                        0.6.2
 #  0.744 tenacity                          8.2.2
 #  0.744 terminado                         0.17.1
 #  0.745 tinycss2                          1.2.1
 #  0.745 tomli                             2.0.1
 #  0.745 tornado                           6.3.2
 #  0.745 traitlets                         5.9.0
 #  0.746 typing_extensions                 4.7.0
 #  0.746 uncertainties                     3.1.7
 #  0.746 uri-template                      1.3.0
 #  0.747 urllib3                           2.0.3
 #  0.747 wcwidth                           0.2.6
 #  0.747 webcolors                         1.13
 #  0.747 webencodings                      0.5.1
 #  0.748 websocket-client                  1.6.1
 #  0.748 wheel                             0.34.2
 #  0.748 widgetsnbextension                4.0.7
 #  0.749 zipp                              3.15.0
 #  DONE 0.8s
#15 [11/15] RUN jupyter notebook --generate-config && echo "\nGenerated jupyter python config file\n"
#15 0.585 Writing default config to: /root/.jupyter/jupyter_notebook_config.py
#15 0.626 
#15 0.626 Generated jupyter python config file
#15 0.626 
#15 DONE 0.7s
#16 [12/15] RUN cat /root/.jupyter/jupyter_notebook_config.py
  ...
  #  Choices: any of ['md5', 'blake2b', 'sha1', 'blake2s', 'sha3_224', 'sha224', 'sha256', 'sha512', 'sha3_512', 'sha3_384', 'sha384', 'sha3_256']
  #  Default: 'sha256'
